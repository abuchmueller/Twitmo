...
If you are using `Twitmo` for the first time, you might already have `rtweet` installed. If you have `rtweet` version \>= 1.0.0 installed, you will not be able to use certain parts of `Twitmo`, like parsing/loading tweets because of breaking changes in `rtweet`. I am currently working on a solution but for now, make sure you have the correct version of `rtweet` installed by running
